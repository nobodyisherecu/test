...
BOT_TOKEN: str = os.environ.get("BOT_TOKEN", "5866086926:AAGycgCtwCHOQ7oJP9SG0oKmNIbfusbz91s")
MESSAGE_CHANNEL_ID: int = int(os.environ.get("MESSAGE_CHANNEL_ID", "-1001696807100"))
...
async def on_private_message(client: Client, message: Message):
    channel = os.environ.get("CHANNEL", "Zyxjgdusbgg")
    if not channel:
...
async def start():
    print('Running')
    await bot.send_message(MESSAGE_CHANNEL_ID, "Hello Temp.")
